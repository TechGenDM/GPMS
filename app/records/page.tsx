                      ...
                      >
                        ...
                        <td className="px-6 py-[16px] text-right whitespace-nowrap">
                          <CurrencyDisplay
                            amount={row.amount}
                            size="sm"
                            className={`font-bold ${isCancelled ? 'text-muted-ink line-through' : 'text-ink'}`}
                          />
                        </td>
                        ...
                        <td className="px-6 py-[16px] whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-[8px] py-[4px] rounded-[6px] text-[12px] font-bold tracking-wide ${
                              isCancelled
                                ? 'bg-[#F4E9EB] text-maroon'
                                : 'bg-[#EAF3EA] text-sage'
                            }`}
                          >
                            {row.status}
