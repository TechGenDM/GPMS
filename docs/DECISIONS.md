...
This document records major architectural decisions made during the development of GPMS. This ensures future maintainers understand *why* a decision was made, not just *what* it is.
